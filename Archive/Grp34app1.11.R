  ...
  dashboardPage(dashboardHeader(title= "", dropdownMenuOutput("messageMenu")), 
                dashboardSidebar(
                  ...
                  tabsetPanel( id = "tabs",
                               ...
                               #Download Tab
                               tabPanel("Download Expression",
                                        textInput("filename", "Please insert desired filename", "Group 3/4 Score"),
                                        radioButtons(inputId = "downloadExp", label = "Select file type", choices = c("csv"= ".csv", "pdf" = ".pdf")),
                                        downloadButton("downExpression", "Download the results")
                               ),
                               tabPanel("Download Methylation",
                                        textInput("filename", "Please insert desired filename", "Group 3/4 Score"),
                                        radioButtons(inputId = "downloadMethy", label = "Select file type", choices = c("csv"= ".csv", "pdf" = ".pdf")),
